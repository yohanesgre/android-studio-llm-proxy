...
```bash
# macOS (Apple Silicon)
curl -L https://github.com/yohanesgre/android-studio-llm-proxy/releases/latest/download/proxy-darwin-arm64 -o proxy
chmod +x proxy
sudo mv proxy /usr/local/bin/

# macOS (Intel)
curl -L https://github.com/yohanesgre/android-studio-llm-proxy/releases/latest/download/proxy-darwin-amd64 -o proxy
chmod +x proxy
sudo mv proxy /usr/local/bin/

# Linux (x86_64)
curl -L https://github.com/yohanesgre/android-studio-llm-proxy/releases/latest/download/proxy-linux-amd64 -o proxy
chmod +x proxy
sudo mv proxy /usr/local/bin/
```
